...
export default function Navbar() {
  return (
    <nav className="fixed top-0 z-10 w-full flex items-center justify-between gap-2 px-2 py-4 text-lg border-b-1 border-stone-300  sm:px-10 md:px-20 bg-[#f5f0e6] ">
      {/* Hash links */}
      <HashLink
        to="/#hero"
        smooth
