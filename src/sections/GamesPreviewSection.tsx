  ...
  return (
    <section
      ...
      <Link
        ...
        <BillyIconSvg />
        <p className="relative pb-10 mt-2 text-center transition-all duration-300 transform opacity-80 md:opacity-0 bottom-1 group-hover:scale-105 group-hover:opacity-100">
