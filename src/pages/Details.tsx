export default function DetailsPage() {
  return (
    <div className="max-w-2xl pt-20 mx-auto sm:pt-3.5 flex-center-100vh">
      <div className="text-left">
        <p>Ceremony: Morden Park House - The Gazebo</p>
        <p className="text-justify ">
          Morden Park House, a stunning Grade II listed Georgian manor, has been
          home to the Merton Register Office since November 2000. Originally
          built in 1770 by John Ewart, this historic building is nestled within
          Morden Park.
        </p>
